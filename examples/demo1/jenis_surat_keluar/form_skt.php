                    ...
                    <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Surat Keterangan  Tanah</div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                    </div>
                                    ...
                                    <div class="form-group form-floating-label">
                                        <input id="inputFloatingLabel" type="number" name="umur" class="form-control input-border-bottom" required>
                                        <label for="inputFloatingLabel" class="placeholder">Umur </label>
                                    </div>
                                     <div class="form-group form-floating-label">
                                        <input id="inputFloatingLabel" type="text" name="pekerjaan" class="form-control input-border-bottom" required>
                                        <label for="inputFloatingLabel" class="placeholder">Pekerjaan </label>
                                    </div>
                                    <div class="form-group form-floating-label">
