...
<head>
    ...
    $result = mysqli_query($conn, "SELECT * FROM data_arsip");
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Lemari Dokumen & File</h4>
                                    </div>
								<div class="card-body">
											...
											<tbody>
                                                <?php while ( $row = mysqli_fetch_assoc($result) )  :?>
													<?php
														...
														if($extensifoto=="jpg"||$extensifoto=="jpeg"||$extensifoto=="png"||$extensifoto=="docx"||$extensifoto=="xlsx"){
															$get_file = '<a href="../../config/public/data/'.$row["file"].'" download>'.$row["file"] .'</a>';
														}else{
															$get_file = '<a href="../../config/public/data/'.$row["file"].'" target="_blank">'.$row["file"] .'</a>';
												...
												<tr>
													...
													<div class="form-button-action">
                                                            <a href="hapus_data_arsip.php?id=<?=$row["id"]; ?>">
